import type { ProductCard as ProductCardType } from '../../types/app-types'
import { DEPT_COLOR } from '../../constants/app-constants'

export default function AppProductCard({ brand, name, price, originalPrice, deptName, deptKey, thumbIcon, thumbColor }: ProductCardType) {
