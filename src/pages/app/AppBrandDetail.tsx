...
import { BRANDS, ALL_LIVE_STREAMS } from '../../constants/app-constants'
  ...
  return (
    <div className="min-h-screen bg-cream-4 pb-20">
      ...
      >
        ...
        <AppBadge type="dept" label={brand.deptName} deptKey={brand.deptKey} className="mb-2" />
        <h1
